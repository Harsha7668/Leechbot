...
class Config((object)):
    ...
    TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6817757005:AAGalWAv3I_D-M_rTCsV4nC5F-dzxwjP118")
    ...
    AUTH_CHANNEL = {int(x) for x in os.environ.get("AUTH_CHANNEL", "-1002131605976").split()}
